...
import { View, StyleSheet, FlatList, ActivityIndicator, Platform, ScrollView, TouchableOpacity } from "react-native";
...
export default function WorkoutScreen() {
  ...
  useEffect(() => {
    ...
    const initializeHealthKit = async () => {
      try {
        ...
        setError("Failed to initialize HealthKit. Please check your permissions.");
        setLoading(false);
      }
    };
    ...
    return (
      <View style={styles.container}>
        <Card style={styles.errorCard}>
          <Text size="lg" bold>HealthKit Not Available</Text>
          <Text>HealthKit is only available on iOS devices. This feature cannot be used on your current device.</Text>
        </Card>
      </View>
    );
  }
  ...
  if (error) {
    return (
      <View style={styles.container}>
        <Card style={styles.errorCard}>
          <Text size="lg" bold>Error Loading Workouts</Text>
          <Text>{error}</Text>
  ...
  return (
    <ScrollView style={styles.scrollView}>
      <View style={styles.container}>
        <Heading size="xl" style={styles.pageTitle}>Running History</Heading>
        ...
        <View style={styles.workoutsContainer}>
          <Heading size="md" style={styles.sectionTitle}>Recent Workouts</Heading>
